...
T, dt = sulib.generate_synthetic_pose_trajectory(trajectory_type="translation_3D")

# Calculate the DUTIR of this pose trajectory
dutir, _ = sulib.pose_trajectory_to_dutir(T, dt, L=0.3, twist_type="body")
...
T, dt = sulib.generate_synthetic_pose_trajectory(trajectory_type="rotation_1D")
